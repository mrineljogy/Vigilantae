...
st.set_page_config(
    page_title="Vigilantae", page_icon="🛡️", initial_sidebar_state="collapsed"
)
apply_theme()

page_header("VIGILANTAE", "Share a sighting securely. Your report could help reunite a family.", "PUBLIC SIGHTING DESK")
