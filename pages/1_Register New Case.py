...
st.set_page_config(page_title="Vigilantae — Register Case", page_icon="🛡️")
apply_theme()
...
if "login_status" not in st.session_state:
    ...
    page_header("REGISTER CASE", "Create a verified record for a missing-person investigation.", "CASE INTAKE")
    ...
    if face_ready:
        with form_col.form(key="new_case_form"):
            ...
            case_reference = st.text_input("Agency Case Reference (optional)")
