...
def _setting(name: str, default: str | None = None) -> str | None:
    """Read a local environment variable or a Streamlit hosting secret."""
...
# Local development uses SQLite. Set DATABASE_URL to a managed PostgreSQL URL before
# deploying so that records persist and can be shared safely by multiple users.
database_url = _setting("DATABASE_URL", "sqlite:///sqlite_database.db")
...
def _migrate_db():
    ...
    new_columns = [
        ...
        ("registeredcases", "guardian_name", "TEXT"),
        ("registeredcases", "case_reference", "TEXT"),
    ]
    try:
